...
class Comic(models.Model):
    ...
    marvel_id = models.PositiveIntegerField(verbose_name='marvel id', null=False, blank=False, unique=True)
    title = models.CharField(verbose_name='title', max_length=120, default='')
    description = models.TextField(verbose_name='description', default='')
    price = models.FloatField(verbose_name='price', max_length=5, default=0.00)
    ...
    def __str__(self):
        ...
        '''
        return f'ID:{self.id} - {self.title} - stock:{self.stock_qty}'
...
class WishList(models.Model):
    ...
    favorite = models.CharField(verbose_name='Favorite', max_length=120, default='')
    ...
    class Meta:
        db_table = 'Whishlist_comics'
        verbose_name = 'Whishlist'
        verbose_name_plural = 'Whishlist_comics'
    ...
    def __str__(self):
        ...
        es lo que retorna cuando llamamos al objeto.
        '''
        return f'ID:{self.id} - Comic:{self.comic} - Carrito:{self.wished_qty}'